...
class SongAdapter:BaseQuickAdapter<Song, QuickViewHolder>(){

    override fun onBindViewHolder(holder: QuickViewHolder, position: Int, item: Song?) {
    ...
    override fun onCreateViewHolder(
        ...
        return QuickViewHolder(R.layout.component_song,parent)
    }
